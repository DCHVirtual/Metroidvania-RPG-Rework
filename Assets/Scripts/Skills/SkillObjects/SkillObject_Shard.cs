...
public class SkillObject_Shard : SkillObject
{
    ...
    {
        target = newTarget ?? ClosestTarget();
        this.speed = speed;
    }
    ...
    public void SetupShard(Skill_Shard shardDetails, float detonationTime, bool canMove, float shardSpeed, Transform target = null)
    {
        this.shardDetails = shardDetails;
        stats = shardDetails.player.stats;
        damageScale = shardDetails.damageScale;
